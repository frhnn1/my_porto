...
<body>
  ...
  <!-- MAIN CONTENT -->
  <h2 data-aos="zoom-in">Login Form</h2>
   <main>
    ...
    <div class="container d-flex flex-wrap gap-4">
        <div class="col-lg-3 col-12 p-3 border border-light rounded-4 text-center" data-aos="fade-right">
          ...
          <img class="mb-4" style="width: 18rem; border-radius: 8px;" src="/my_porto/assets/loginr.png" alt="">
        </div>
      <div class="col-lg-8 col-12 p-3 border border-light rounded-4" data-aos="fade-left">
        <h2>Project Background</h2><br>
        <p>Dalam era digital saat ini, keamanan akun pengguna menjadi salah satu aspek terpenting dalam pengembangan aplikasi web. Untuk meningkatkan perlindungan terhadap akses tidak sah, sistem autentikasi menggunakan OTP (One-Time Password) yang dikirim melalui email menjadi solusi yang efektif. Dengan menggunakan pendekatan ini, pengguna diwajibkan memverifikasi identitas mereka melalui OTP yang dikirimkan ke alamat email mereka saat proses registrasi, sehingga hanya pemilik email yang sah yang dapat melanjutkan ke tahap berikutnya.</p>
        <p>Proyek ini saya pilih karena memberikan kesempatan untuk memahami implementasi sistem autentikasi yang lebih aman menggunakan verifikasi OTP melalui Gmail. Sistem ini dikembangkan menggunakan HTML, CSS, PHP, dan MySQL, dengan tujuan menciptakan proses login dan registrasi yang tidak hanya aman, tetapi juga responsif dan mudah digunakan. Teknologi yang digunakan bersifat ringan dan cocok untuk pembelajaran maupun pengembangan lanjutan, sekaligus memberikan gambaran nyata tentang praktik keamanan dalam dunia web modern.</p>
      </div>
   </main>
