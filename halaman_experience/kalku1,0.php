...
<body>
  ...
  <!-- MAIN CONTENT -->
  <h2 data-aos="zoom-in">Kalkulator Sederhana</h2>
   <main>
    ...
    <div class="container d-flex flex-wrap gap-4">
        <div class="col-lg-3 col-12 p-3 border border-light rounded-4 text-center" data-aos="fade-right">
          ...
          <img class="mb-4" style="width: 18rem; border-radius: 8px;" src="/my_porto/assets/kalkul.png" alt="">
        </div>
      <div class="col-lg-8 col-12 p-3 border border-light rounded-4" data-aos="fade-left">
        <h2>Project Background</h2><br>
        <p>Proyek pembuatan website kalkulator sederhana ini merupakan bagian dari tugas sekolah yang bertujuan untuk melatih kemampuan dalam membangun aplikasi web dasar. Dalam proyek ini, digunakan HTML dan CSS untuk membuat struktur dan tampilan antarmuka, serta JavaScript sebagai bahasa pemrograman utama untuk mengatur logika perhitungan.</p>
        <p>Meskipun kalkulator sudah tersedia di hampir semua perangkat, pembuatan kalkulator berbasis web tetap relevan sebagai sarana belajar. Proyek ini membantu siswa memahami cara kerja elemen-elemen web secara terpadu serta meningkatkan keterampilan teknis dalam mengembangkan aplikasi yang interaktif dan responsif.</p>
      </div>
   </main>
